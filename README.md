...
The vast majority of these implementations were done by me without the assistance of any LLM. Some of them---namely, Ada, Factor, Forth, Common Lisp, TypeScript, and Janet---were done by [Claude Code](https://claude.com/product/claude-code) as an exercise in using AI-assisted tools. Claude's implementations in Factor and Forth were faulty.